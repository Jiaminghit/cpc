...
```text
1. 取 bbox 内所有点的 camera depth = points_camera[:, 2]
2. 按 depth 从小到大排序
3. 取最近的 depth_percentile 点，例如前 20%
4. 如果前 20% 点数少于 min_points_used，则至少取 min_points_used 个
5. 对选中的 points_ego 取 median，作为 representative_point_ego
```
